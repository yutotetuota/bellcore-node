...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bellcore-lib': 'git://github.com/bellcoin-electrum/bellcore-lib.git',
    'bellcore-node': 'git://github.com/bellcoin-electrum/bellcore-node.git'
  }
};

/**
 * Will create a directory and bellcoin.conf file for Bellcoin.
...
/**
 * Will create a base Bellcore Node configuration directory and files.
 * @param {Object} options
 * @param {String} options.network - "testnet" or "livenet"
 * @param {String} options.datadir - The bellcoin database directory
...
/**
 * Will setup a directory with a Bellcore Node directory, configuration file,
 * bellcoin configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the bellcore node configuration directory
 * @param {String} options.datadir - The path to the bellcoin datadir
...
function create(options, done) {
  ...
  async.series([
    ...
    function(next) {
      // Setup the bellcoin directory and configuration
